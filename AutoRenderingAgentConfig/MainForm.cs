...
public class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        _portBox = new NumericUpDown { Dock = DockStyle.Fill, Minimum = 1, Maximum = 65535 };
        _projectPathBox = new TextBox { Dock = DockStyle.Fill };
        _browseButton = new Button { Text = "...", Dock = DockStyle.Fill };
        _takeBox = new NumericUpDown { Dock = DockStyle.Fill, Minimum = 1, Maximum = 99999 };
        _stopRenderButton = CreateStopButton();
        _saveButton = CreateSaveButton();
        _configPathLabel = CreateConfigPathLabel();
    ...
    private static Button CreateStopButton() => new()
    {
        Text = "Stop Rendering",
        Dock = DockStyle.Fill,
        Height = 36,
    ...
    private static Button CreateSaveButton() => new()
    {
        Text = "Save",
    ...
    private static Label CreateConfigPathLabel() => new()
    {
        Dock = DockStyle.Fill,
        AutoEllipsis = true,
